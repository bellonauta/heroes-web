...
na pasta aws. As APIs estarão ativas até o dia 10/05/2021. Após essa data,
você poderá testar utilizando os códigos em Python fornecidos, na sua conta AWS.
Nesse caso, você terá que baixar os fontes do projeto em flutter, do repositório 
https://github.com/bellonauta/heroes.git e promover as alterações
no arquivo lib/core/app_consts.dart e gerar novo build web da aplicação.
